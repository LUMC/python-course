...
\begin{pframe}
 \begin{center}
  \includesvg[width=0.95\textwidth]{../../images/program_special.svg}
 \end{center}
\end{pframe}
...
\begin{pframe}
 ...
 \begin{itemize}
  ...
  \begin{itemize}
   ...
   \item \hrefc{linkc}{https://docs.python.org/3.7/reference/lexical_analysis.html\#keywords}{Reserved words} (\emp{if}, \emp{then}, \emp{for}, etc.)
