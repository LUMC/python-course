...
\begin{pframe}
 ...
 \begin{enumerate}
  ...
  \item \textbf{Bank account simulator} \\
        Take as input an initial bank account amount. Next, accept inputs
        consisting of expenses / revenues until the user introduces \emp{exit}.
        After each input, in case the balance is about to go negative, print an
        error message, otherwise print the new balance value.
 \end{enumerate}
\end{pframe}
