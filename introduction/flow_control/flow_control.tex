...
300}}
 ...
 \begin{minipage}{0.57\textwidth}
 \begin{center}
  \includesvg[width=0.7\textwidth]{../../images/a_b_4.svg}
 \end{center}
 \end{minipage}%
\end{pframe}
...
\begin{enumerate}
  ...
  \item \textbf{Integer to a list} \\
        Take as input two integers. Transform the first one into a list of digits to which the other number is added. So \emp{2345} and \emp{3} are transformed into \emp{[5,6,7,8]}.
 \end{enumerate}
\end{pframe}
